...
test.a[,,,1:2,'all'] <- test.a[,,,1:2,'all']*100
dimnames(test.a)[[2]] <- c('\\tr{}','\\naive{}','\\default{}')
print(xtable(aperm(test.a[12,,,1:3,'all'],c(1,3,2))[,,1],display=c('s','f','f','f'),digits=3),only.contents=T,include.colnames=FALSE,hline.after=NULL, format.args=list(big.mark = " ", decimal.mark = "."),add.to.row=list(pos=list(0,0),command=c('\\multicolumn{4}{l}{\\textbf{Panel A: Consensus}} \\\\ \n','\\midrule \n')),sanitize.text.function = function(x) x)
@
\end{tabularx}
...
#cat(rep('&',ncol(results.final)),'\\\\')
print(xtable(aperm(test.a[12,,,1:3,'all'],c(1,3,2))[,,2],display=c('s','f','f','f'),digits=3),only.contents=T,include.colnames=FALSE,hline.after=NULL, format.args=list(big.mark = " ", decimal.mark = "."),add.to.row=list(pos=list(0,0),command=c('\\multicolumn{4}{l}{\\textbf{Panel B: TP}} \\\\ \n','\\midrule \n')),sanitize.text.function = function(x) x)
@
  \end{tabularx}
  \begin{tabularx}{\linewidth}{r*{4}{Y}}
...
#cat(rep('&',ncol(results.final)),'\\\\')
print(xtable(aperm(test.a[12,,,1:3,'all'],c(1,3,2))[,,3],display=c('s','f','f','f'),digits=3),only.contents=T,include.colnames=FALSE,hline.after=NULL, format.args=list(big.mark = " ", decimal.mark = "."),add.to.row=list(pos=list(0,0),command=c('\\multicolumn{4}{l}{\\textbf{Panel C: EPS}} \\\\ \n','\\midrule \n')),sanitize.text.function = function(x) x)
@
\bottomrule
\end{tabularx}
  \end{table}
...
print(xtable(aperm(test.a[,,c(1,3,2),4,'all'],c(1,3,2))[,,1],display=c('s','d','d','d'),digits=3),only.contents=T,include.colnames=FALSE,hline.after=NULL, format.args=list(big.mark = " ", decimal.mark = "."),add.to.row=list(pos=list(0,0,11),command=c('\\multicolumn{4}{l}{\\textbf{Panel A: \\tr{}}} \\\\ \n','\\midrule \n','\\midrule \n')),sanitize.text.function = function(x) x)
@
\end{tabularx}
\begin{tabularx}{\linewidth}{r*{4}{Y}}
<<stocks-naive,echo=F,results='asis'>>=
print(xtable(aperm(test.a[,,c(1,3,2),4,'all'],c(1,3,2))[,,2],display=c('s','d','d','d'),digits=3),only.contents=T,include.colnames=FALSE,hline.after=NULL, format.args=list(big.mark = " ", decimal.mark = "."),add.to.row=list(pos=list(0,0,11),command=c('\\multicolumn{4}{l}{\\textbf{Panel B: \\naive{}}} \\\\ \n','\\midrule \n','\\midrule \n')),sanitize.text.function = function(x) x)
@
\end{tabularx}
\begin{tabularx}{\linewidth}{r*{4}{Y}}
<<stocks-def,echo=F,results='asis'>>=
print(xtable(aperm(test.a[,,c(1,3,2),4,'all'],c(1,3,2))[,,3],display=c('s','d','d','d'),digits=3),only.contents=T,include.colnames=FALSE,hline.after=NULL, format.args=list(big.mark = " ", decimal.mark = "."),add.to.row=list(pos=list(0,0,11),command=c('\\multicolumn{4}{l}{\\textbf{Panel C: \\default{}}} \\\\ \n','\\midrule \n','\\midrule \n')),sanitize.text.function = function(x) x)
@
\bottomrule
\end{tabularx}
\end{table}
...
print(xtable(bl.results[1:3,1,,'all'],display=c('s','f','f','f','d','f'),digits=4),only.contents=T,include.colnames=FALSE,hline.after=NULL, format.args=list(big.mark = " ", decimal.mark = "."),add.to.row=list(pos=list(nrow(bl.results[1:3,1,,'all'])),command=c('\\midrule \n')),sanitize.text.function = function(x) x)
@
\end{tabularx}
...
print(xtable(bl.results[1:3,2,,'all'],display=c('s','f','f','f','d','f'),digits=4),only.contents=T,include.colnames=FALSE,hline.after=NULL, format.args=list(big.mark = " ", decimal.mark = "."),,add.to.row=list(pos=list(nrow(bl.results[1:3,2,,'all'])),command=c('\\midrule \n')),sanitize.text.function = function(x) x)
@
\end{tabularx}
\begin{tabularx}{\linewidth}{r*{5}{Y}}
  \multicolumn{5}{l}{\textbf{Panel D: \default{}}} \\
<<bl-eps,echo=F,results='asis'>>=
print(xtable(bl.results[1:3,3,,'all'],display=c('s','f','f','f','d','f'),digits=4),only.contents=T,include.colnames=FALSE,hline.after=NULL, format.args=list(big.mark = " ", decimal.mark = "."),sanitize.text.function = function(x) x)
@
\bottomrule
\end{tabularx}
\end{table}
...
print(xtable(acast(melt(periods.array[,c(4,1,2,3),1,'yes',c(1,4),'all']),Var1~Var2+Var3,value.var='value'),display=c('s','f','f','f','f','f','f','f','f'),digits=4),only.contents=T,include.colnames=F,hline.after=NULL, format.args=list(big.mark = " ", decimal.mark = "."),add.to.row=list(pos=list(0,6),command=c('\\multicolumn{9}{l}{\\textbf{Panel A: \\tr{}}} \\\\\n', '\\midrule \n')))
...
print(xtable(acast(melt(periods.array[,c(4,1,2,3),2,'yes',c(1,4),'all']),Var1~Var2+Var3,value.var='value'),display=c('s','f','f','f','f','f','f','f','f'),digits=4),only.contents=T,include.colnames=F,hline.after=NULL, format.args=list(big.mark = " ", decimal.mark = "."),add.to.row=list(pos=list(0,6),command=c('\\multicolumn{9}{l}{\\textbf{Panel B: \\naive{}}} \\\\\n', '\\midrule \n')))
...
print(xtable(acast(melt(periods.array[,c(4,1,2,3),3,'yes',c(1,4),'all']),Var1~Var2+Var3,value.var='value'),display=c('s','f','f','f','f','f','f','f','f'),digits=4),only.contents=T,include.colnames=F,hline.after=NULL, format.args=list(big.mark = " ", decimal.mark = "."),add.to.row=list(pos=list(0,6),command=c('\\multicolumn{5}{l}{\\textbf{Panel C: \\default{}}} \\\\\n','\\midrule \n')))
@
\bottomrule
\end{tabular}}
\end{table}
