...
print(xtable(acast(melt(test.a[12,,'CONS',1:3,]),Var1~Var2+Var3,value.var='value'),display=c('s','f','f','f','f','f','f'),digits=3),only.contents=T,include.colnames=FALSE,hline.after=NULL, format.args=list(big.mark = " ", decimal.mark = "."),add.to.row=list(pos=list(0,0),command=c('\\multicolumn{7}{c}{\\textbf{Panel A: Consensus}} \\\\ \n','\\midrule \n')),sanitize.text.function = function(x) x)
@
\end{tabularx}
...
print(xtable(acast(melt(test.a[,1,c(1,3,2),4,]),Var1~Var2+Var3,value.var='value'),display=c('s','d','d','d','d','d','d'),digits=3),only.contents=T,include.colnames=FALSE,hline.after=NULL, format.args=list(big.mark = " ", decimal.mark = "."),add.to.row=list(pos=list(0,0,11),command=c('\\multicolumn{7}{l}{\\textbf{Panel A: \\tr{}}} \\\\ \n','\\midrule \n','\\midrule \n')),sanitize.text.function = function(x) x)
@
\end{tabularx}
...
print(xtable(acast(melt(bl.results[1:3,1,,]),Var1~Var2+Var3,value.var='value'),display=c('s','f','f','f','f','f','f','d','d','f','f'),digits=3),only.contents=T,include.colnames=FALSE,hline.after=NULL, format.args=list(big.mark = " ", decimal.mark = "."),add.to.row=list(pos=list(nrow(bl.results[1:3,1,,'all'])),command=c('\\midrule \n')),sanitize.text.function = function(x) x)
@
\end{tabular}}
...
print(xtable(acast(melt(periods.array[,c(4,1,2,3),1,'yes',c(1,4),'all']),Var1~Var2+Var3,value.var='value'),display=c('s','f','f','f','f','f','f','f','f'),digits=3),only.contents=T,include.colnames=F,hline.after=NULL, format.args=list(big.mark = " ", decimal.mark = "."),add.to.row=list(pos=list(0,6),command=c('\\multicolumn{9}{l}{\\textbf{Panel A: \\tr{}}} \\\\\n', '\\midrule \n')))
