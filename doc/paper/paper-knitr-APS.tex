...
Panel A show the statistics for the consensus expectations as defined in eq. (\ref{consq}). The average consensus among the analysts on stock expected returns in the  \tr{}, \naive{} and \default{} information sets are, respectively, NA\%, 18.615\%, and 18.615\% respectively. Panel B of the table shows the TP accuracy weighted average expected returns (14.876\%, 15.738\%, and 12.461\%). Panel C shows the EPS based weighted expected returns averages (14.696\%, 14.895\%, and 12.857\%). 
...
\label{sec:perfect}
Panel B presents the results for the case of the \tr{} information set. The annualized cumulative returns for each of the active strategies (\textit{CONS}, \textit{TP}, and \textit{EPS}) are, respectively, NA\%, 4.288\%, 0.565\%. All the strategies outperform the passive benchmark (\ensuremath{-3.032}\%). The results show, as expected, that  we would better off if we knew in advance who the top analysts in terms of TP accuracy would be. In any case, the results suggest that the advice of analysts, as a group, is valuable. 
%Yet, the top analyst  
...
The \textit{TP} ranking strategy dominates also when we look at the risk-adjusted returns. The Sharpe Ratio is 0.292 against NA, 0.036, and \ensuremath{-0.182}, respectively for the \textit{CONS}, the \textit{EPS}, and the \textit{Market} strategies. In addition, the \textit{TP} strategy dominates  the others if we consider the smaller trading periods (5 years). Table \ref{tab:substrategy} shows the Sharpe Ratio for six 5-year holding periods. The \textit{TP} strategy wins over the others in every period as expected.
...
Panel D of table \ref{tab:strategy} confirm the outperformance of the \textit{TP} smart strategy: this is the the only active strategy that yields positive annualized cumulative return (0.681\%) whereas both  the \textit{CONS} and the \textit{EPS} show negative returns (0.323\% and 0.738\% respectively). The panel C of table \ref{tab:substrategy} shows that the Sharpe Ratio of the \textit{TP} strategy is lower then that of the \textit{EPS} strategy in only first two sub-periods (2000Q1/2004Q4 and 2001Q1/2005Q4).
...
\tr{} & - & - & - & - & - & - \\ 
  ...
  \default{} & 18.615 & 18.993 & 16.866 & 17.173 & 0.120 & 0.119 \\ 
...
\begin{tabularx}{\linewidth}{r*{7}{Y}}
 ...
 \midrule 
\tr{} & 14.876 & 15.191 & 13.369 & 13.595 & 0.096 & 0.096 \\ 
  \naive{} & 15.738 & 16.098 & 14.304 & 14.528 & 0.098 & 0.098 \\ 
  \default{} & 12.461 & 12.718 & 10.588 & 10.789 & 0.088 & 0.089 \\ 
...
\begin{tabularx}{\linewidth}{r*{7}{Y}}
 ...
 \midrule 
\tr{} & 14.696 & 14.774 & 13.233 & 13.269 & 0.101 & 0.102 \\ 
  \naive{} & 14.895 & 14.967 & 13.393 & 13.432 & 0.103 & 0.103 \\ 
  \default{} & 12.857 & 12.928 & 11.410 & 11.440 & 0.089 & 0.089 \\ 
...
\begin{tabular}{rrrrrrrrrrr}
 ...
 \textit{CONS} & - & - & - & - & - & - & - & - & - & - \\ 
  \textit{TP} & 4.288 & 4.512 & 14.695 & 14.792 & 0.292 & 0.305 &  284 &  251 & 0.344 & 0.326 \\ 
  \textit{EPS} & 0.565 & 0.718 & 15.541 & 15.509 & 0.036 & 0.046 &  205 &  205 & 0.495 & 0.493 \\ 
   \midrule 
...
\begin{tabular}{rrrrrrrrrrr}
 ...
 \textit{CONS} & 0.126 & 0.449 & 15.947 & 15.993 & 0.008 & 0.028 &  284 &  252 & 0.256 & 0.250 \\ 
  \textit{TP} & 0.281 & 0.622 & 15.661 & 15.682 & 0.018 & 0.040 &  284 &  252 & 0.264 & 0.256 \\ 
  \textit{EPS} & -0.318 & -0.361 & 16.094 & 16.100 & -0.020 & -0.022 &  206 &  206 & 0.409 & 0.408 \\ 
   \midrule 
...
\begin{tabular}{rrrrrrrrrrr}
 ...
 \textit{CONS} & 0.323 & 0.702 & 15.771 & 15.820 & 0.020 & 0.044 &  284 &  252 & 0.228 & 0.223 \\ 
  \textit{TP} & 0.681 & 1.043 & 15.553 & 15.476 & 0.044 & 0.067 &  284 &  252 & 0.256 & 0.248 \\ 
  \textit{EPS} & 0.738 & 0.711 & 15.446 & 15.481 & 0.048 & 0.046 &  245 &  245 & 0.256 & 0.255 \\ 
