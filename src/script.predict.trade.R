...
ggplot(unique(final.bl[Views!='Market'],by=c('Quarters','n.views','Method','Views','type')),aes(x=as.Date(Quarters),y=n.views,group=Method,color=Method))+geom_point()+geom_line()+facet_grid(Views~type,scale='free_x')+theme_bw()
