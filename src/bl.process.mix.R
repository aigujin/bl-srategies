opt.w<- rbindlist(lapply(c('last','ma','w.ma'),function(agg){
  list.conf <- c(alply(case.3.rank.conf[,,,agg],2,.dims=T),alply(non.r.conf[,,,agg],2,.dims=T))
  
  rbindlist(lapply(names(list.views),function(type){
    rbindlist(
      switch(type,
        'true'=script.weights.env.f(type,market.list[m.period],list.views[[type]][bl.period,],list.conf[[type]][bl.period,],0.02,2.5),
        'naive'=script.weights.env.f(type,market.list[m.period],list.views[[type]][bl.period,],list.conf[[type]][bl.period,],0.02,2.5),
        'default'=script.weights.env.f(type,market.list[m.period],list.views[[type]][bl.period,],list.conf[[type]][bl.period,],0.02,2.5),
        'raw'=script.weights.env.f(type,market.list[m.period],list.views[[type]][bl.period,],list.conf[[type]][bl.period,],0.02,2.5),
        '1diff'=script.weights.env.f(type,market.list[m.period],list.views[[type]][bl.period,],list.conf[[type]][bl.period,],0.02,2.5),
        'roll.sd'=script.weights.env.f(type,market.list[m.period],list.views[[type]][bl.period,],list.conf[[type]][bl.period,],0.02,2.5),
        'random'=script.weights.env.f(type,market.list[m.period],list.views[[type]][bl.period,],list.conf[[type]][bl.period,],0.02,2.5),
        'true.nr'=non.rank.script.weights.env.f(type,market.list[m.period],list.views[[type]][bl.period,],list.conf[[type]][bl.period,],0.02,2.5),
        'naive.nr'=non.rank.script.weights.env.f(type,market.list[m.period],list.views[[type]][bl.period,],list.conf[[type]][bl.period,],0.02,2.5),
        'default.nr'=non.rank.script.weights.env.f(type,market.list[m.period],list.views[[type]][bl.period,],list.conf[[type]][bl.period,],0.02,2.5))
      )[,Aggregation:=agg]
  }))
}))
